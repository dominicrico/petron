					...
					addToPlaylist: function(track) {
						ngDialog.open({
							...
							controller: ['$scope', 'petron.playlist', function($scope,
								...
								if (name) {
									$scope.usePlaylist = $scope.ngDialogData.playlists[name].name;
								} else {
												...
												$scope.savePlaylist = function() {
													petronPlaylist.newPlaylist({
														...
														petronPlaylist.addToPlaylist($scope.name,
															...
															$rootScope.audio.playlists[$scope.name] =
								...
								$scope.addToPlaylist = function() {
									petronPlaylist.addToPlaylist($scope.ngDialogData.playlists[
										...
										$rootScope.audio.playlists[$scope.usePlaylist] = $scope.ngDialogData
						...
						controller: ['$scope', 'petron.playlist', function($scope,
							...
							$scope.confirm = function() {
								petronPlaylist.clearQueue().then(function(queue) {
									$scope.$parent.queue = $scope.$parent.$root.audio.queue =
										queue;
									petronPlaylist.save();
									$scope.closeThisDialog();
								});
