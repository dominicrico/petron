...
angular.module("index.html", []).run(["$templateCache", function ($templateCache) {
  ...
  $templateCache.put("index.html",
    ...
    "</head>\n" +
    "\n" +
    "<body ng-cloak=\"\" hm-Swipeup=\"$root.goHome\" hm-Swipeleft=\"$root.toggleMode\" hm-Swiperight=\"$root.toggleMode\" hm-panend=\"setVolume\" hm-panstart=\"getVolume\" hm-panup=\"volumeIndicator\" hm-pandown=\"volumeIndicator\" hm-recognizer-options='[{\"type\": \"swipe\", \"enable\": false, \"directions\": \"DIRECTION_HORIZONTAL|DIRECTION_UP\", \"threshold\": 200},{\"type\":\"pan\",\"enable\": true, \"directions\": \"DIRECTION_VERTICAL\", \"threshold\": 50, \"pointers\": 1 }]'>\n" +
...
angular.module("js/_modules/phone_module/_template/messages.html", []).run(["$templateCache", function ($templateCache) {
  ...
  $templateCache.put("js/_modules/phone_module/_template/messages.html",
    "<section class=\"columns u--max-height__100 u--margin-top__none c--phone\">\n" +
    "  <div class=\"column\">\n" +
    "    <ul class=\"c--filetree__list\" ng-if=\"messages\">\n" +
    "    	<li ng-repeat=\"msg in messages\" hm-tap=\"readMessage(msg)\">\n" +
    "    		<div class=\"columns is-vcentered\">\n" +
    "    			<div class=\"column is-narrow is-paddingless\">\n" +
    "    				<figure class=\"image is-32x32\">\n" +
    "    					<span class=\"icon is-medium\">\n" +
    ...
    "    				<div class=\"columns\">\n" +
    "    					<div class=\"column\">\n" +
    "    						{{ msg.Sender }} - {{ msg.Timestamp | date:'dd.MM.yyyy H:m' }}\n" +
    "    					</div>\n" +
    "    				</div>\n" +
    "    				<div class=\"columns c--filetree__title\">\n" +
    "    					<div class=\"column\">\n" +
    "    						{{ msg.Subject }}\n" +
    "    					</div>\n" +
    "    				</div>\n" +
