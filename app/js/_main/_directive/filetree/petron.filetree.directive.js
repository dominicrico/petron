(function() {
  ...
  angular.module('petron.core')
    .directive('petronFiletree', ['petron.fs', 'ngDialog', '$rootScope',
      function(petronFs, ngDialog, $rootScope) {
        return {
          ...
          link: function(scope) {
            ...
            scope.popout = function(event) {
              ...
              if (scope.type !== 'video') {
                ...
                popout =
                  'js/_main/_directive/filetree/video_popout.html';
              }
            ...
            scope.openParent = function(folder) {
              $rootScope.fileTreeLevel = $rootScope.fileTreeLevel + 1;
            ...
            scope.open = function(file, index) {
              if (file.type !== 'folder') {
                if (scope.type !== 'playlist' && scope.type !==
                  'audio_playlist' &&
