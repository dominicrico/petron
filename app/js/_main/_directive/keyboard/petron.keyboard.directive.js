        ...
        return {
          ...
          controller: ['$scope', '$attrs', function($scope, $attrs) {
            $scope.getTemplate = function() {
              var base = 'js/_main/_directive/';
              if ($attrs.layout && ['qwerty', 'qwertz'].indexOf(
                  $attrs.layout) !== -1) {
                return base + '/keyboard/layout_' +
                  $attrs.layout +
                  '.html';
              } else {
                return base + 'keyboard/layout_qwertz.html';
              }
            };
          }],
          link: function() {
            ...
            $rootScope.$onMany(['$stateChangeSuccess', 'ngDialog.opened'],
              function() {
                $timeout(function() {
                  $('input[type="text"]').on('click focus',
                    function(e) {
